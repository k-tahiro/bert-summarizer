...
from bert_summarizer.trainers.lr_lambda import TransformerScheduler, get_transformer_schedule_with_warmup
...
class TestGetScheduler:
    ...
    @pytest.mark.parametrize('num_warmup_steps, expected', [
        (10000, [10000, 10000]),

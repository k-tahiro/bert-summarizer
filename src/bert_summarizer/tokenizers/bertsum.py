...
class BertSumTokenizer(BertTokenizer):
    def build_inputs_with_special_tokens(
        ...
        return cls + token_ids_0 + sent_sep_token_ids + token_ids_1 + sep
    ...
    def create_token_type_ids_from_sequences(
        ...
        return len(cls + token_ids_0 + former_sent_sep_token_ids) * [0] + len(
            latter_sent_sep_token_ids + token_ids_1 + sep
        ) * [1]
